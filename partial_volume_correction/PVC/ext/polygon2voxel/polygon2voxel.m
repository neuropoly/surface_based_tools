function [Volume, Volume1]=polygon2voxel(FV,VolumeSize,mode,normal_vect,Yxz)
...
if (normal_vect)
    [Volume,Volume1]=polygon2voxel_double_copy(FacesA,FacesB,FacesC,VerticesX,VerticesY,VerticesZ,VolumeSize);
else
